...
import { CodeListAnalyzer } from './analyzers/codelist-analyzer';
...
export const codeListAnalyzer = new CodeListAnalyzer({ labelPredicates: [SKOS.prefLabel(), RDFS.label()], codePredicates: [SKOS.notation()] });
