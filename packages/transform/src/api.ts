...
export { createUpdateEntityInstancesUris } from './factory/create-update-entity-instances-uris';
...
export { createUpdatePropertyLiteralsValueTransformation } from './factory/create-update-property-literals-value-transformation';
export { createUpdatePropertyLiteralsPatternTransformation } from './factory/create-update-property-literals-pattern-transformation';
